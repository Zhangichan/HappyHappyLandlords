...
Login::Login(QWidget *parent) :
    ...
    ui(new Ui::Login)
{
        setWindowFlags(Qt::FramelessWindowHint);//去掉qt标题栏
//        setAttribute(Qt::WA_TranslucentBackground);//设置透明2-窗体标题栏不透明,背景透明
    originWindow();        //配置窗体属性
...
{
    setFixedSize(480,360);//*0.6
}
//窗体背景绘制
void Login::paintEvent(QPaintEvent *event)
{
    static QPixmap backpic(":/res/login.png");
...
void Login::originLoginLabel()
{
    ...
    loginLabel->setGeometry(40,30,400,80);
    QFont font;
    ...
    loginLabel->setText("一起快活斗地主");
}
//配置账号标签属性
void Login::originAccountLabel()
{
    accountLabel=new QLabel(this);
    accountLabel->setGeometry(90,120,150,50);
    accountLabel->setText("账号 :");
    QFont font;
    font.setFamily(QStringLiteral("方正喵呜体"));
...
void Login::originPwdLabel()
{
    ...
    passwordLabel->setGeometry(90,210,150,50);
...
void Login::originAccountInput()
{
    ...
    accountLineEdit->setGeometry(170,112,220,50);
    QFont font;
    font.setFamily(QStringLiteral("方正喵呜体"));
    font.setPointSize(25);
    font.setBold(true);
    accountLineEdit->setFont(font);
    accountLineEdit->setPlaceholderText("输入帐号");
...
void Login::originPwdInput()
{
    ...
    passwordLineEdit->setGeometry(170,202,220,50);
    QFont font;
    font.setFamily(QStringLiteral("方正喵呜体"));
    font.setPointSize(25);
    font.setBold(true);
...
void Login::originButtons()
{
    ...
    loginBtn->setGeometry(70,290,100,40);
    ...
    registerBtn->setGeometry(220,290,100,40);
    font.setPointSize(24);
    ...
    returnBtn->setGeometry(360,310,60,20);
    returnBtn->setStyleSheet("background-color:#2b2b2b;color:#ffffff");
    returnBtn->setText("返回");
    font.setPointSize(12);
    returnBtn->setFont(font);
    returnBtn->installEventFilter(this);
}
void Login::returnBtnSlot()
{
    if(_canReturn)
    {
        _canReturn=false;
